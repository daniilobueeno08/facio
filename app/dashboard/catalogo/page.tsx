...
const C = {
  bg: "#FFFFFF", surface: "#F4F6F3", text: "#1A1A2E",
  muted: "#6B7280", border: "#E5E7EB", primary: "#639922", navy: "#1A1A2E",
};
    ...
    <main style={{ minHeight: "100vh", background: C.surface }}>
      <header style={{ background: C.bg, borderBottom: `1px solid ${C.border}`, padding: "16px 20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <form action="/api/auth/signout" method="post">
          <button type="submit" style={{ fontSize: 13, color: C.muted, background: "none", border: "none", cursor: "pointer" }}>
            Sair
          </button>
        </form>
      </header>
      ...
      <div style={{ maxWidth: 520, margin: "0 auto", padding: "24px 20px" }}>
        <h1 style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 22, color: C.navy, marginBottom: 4 }}>
          Olá, {profile?.nome ?? ""}
        </h1>
        ...
        <Link href="/dashboard/historico" style={{ textDecoration: "none" }}>
          <div style={{ background: C.bg, border: `1px solid ${C.border}`, color: C.navy, borderRadius: 14, padding: "14px 20px", textAlign: "center", fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 13, marginBottom: 10 }}>
            Ver histórico completo
          </div>
        </Link>

        <Link href="/dashboard/catalogo" style={{ textDecoration: "none" }}>
          <div style={{ background: C.bg, border: `1px solid ${C.border}`, color: C.muted, borderRadius: 14, padding: "14px 20px", textAlign: "center", fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 13, marginBottom: 24 }}>
